        ...
        <div class="m-12">
            ...
            <ul class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 justify-center items-center">
                ...
                <li class="text-center">
                    <a
                        href="https://www.amvieyewear.com/eyewear-trends/classic"
                ...
                <li class="text-center">
                    <a
                        href="https://www.amvieyewear.com/eyewear-trends/eco-friendly"
                        class="group flex flex-col items-center">
                        <img
                ...
                <li class="text-center">
                    <a
                        href="https://www.amvieyewear.com/eyewear-trends/artsy"
                        class="group flex flex-col items-center">
                        <img
                ...
                <li class="text-center">
                    <a
                        href="https://www.amvieyewear.com/eyewear-trends/retro"
                        class="group flex flex-col items-center">
                        <img
                ...
                <li class="text-center">
                    <a
                        href="https://www.amvieyewear.com/eyewear-trends/street-style"
                        class="group flex flex-col items-center">
                        <img
                ...
                <li class="text-center">
                    <a
                        href="https://www.amvieyewear.com/eyewear-trends/bold"
                        class="group flex flex-col items-center">
                        <img
